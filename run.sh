...
CUDA_VISIBLE_DEVICES=2 python fix_dyth_recon.py --dataset cifar10 --date 1119 --tempt 1 --label_ratio 2 --imb_ratio 100 --num_max 1500  --epochs 500 --closstemp 0.1 --distance 0.1 --lam 1  --conu 0 --dismod furst --diskey 3 --weakth 0.95 --cl12 0.6667 --usedyth 1 --use-la 1 --usecsl 1 --lbdcsl 1.5 --wk 3
CUDA_VISIBLE_DEVICES=2 python fix_dyth_recon.py --dataset cifar10 --date 1119 --tempt 2 --label_ratio 2 --imb_ratio 100 --num_max 1500  --epochs 500 --closstemp 0.1 --distance 0.1 --lam 1  --conu 0 --dismod furst --diskey 3 --weakth 0.95 --cl12 0.6667 --usedyth 1 --use-la 0 --usecsl 0 --lbdcsl 1.5 --wk 3
CUDA_VISIBLE_DEVICES=2 python fix_dyth_recon.py --dataset cifar10 --date 1119 --tempt 3 --label_ratio 2 --imb_ratio 100 --num_max 1500  --epochs 500 --closstemp 0.1 --distance 0.1 --lam 1  --conu 0 --dismod furst --diskey 3 --weakth 0.95 --cl12 0.6667 --usedyth 1 --use-la 1 --usecsl 0 --lbdcsl 1.5 --wk 3
CUDA_VISIBLE_DEVICES=2 python fix_dyth_recon.py --dataset cifar10 --date 1119 --tempt 0 --label_ratio 2 --imb_ratio 100 --num_max 1500  --epochs 500 --closstemp 0.1 --distance 0.1 --lam 1  --conu 0 --dismod furst --diskey 3 --weakth 0.95 --cl12 0.6667 --usedyth 0 --use-la 0 --usecsl 0 --lbdcsl 1.5 --wk 3