...
CUDA_VISIBLE_DEVICES=0 python ABCfix_v6_5_dy_th.py --dataset cifar100 --out cf100_0610t2 --txtp /data/lipeng/ABC/txt/cf100_0610t --label_ratio 2 --imb_ratio 10 --num_max 150  --epochs 500 --closstemp 0.1 --distance 0.1 --lam 1 --oe False  --tempt 2 --conu False --use-la False --comb False  --dismod furst --diskey 3 --weakth 0.55
