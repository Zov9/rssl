...
CUDA_VISIBLE_DEVICES=3 python ABCfix_v6_5_dy_th.py --dataset cifar100 --out cf100_0610t1 --txtp /data/lipeng/ABC/txt/cf100_0610t --label_ratio 2 --imb_ratio 10 --num_max 150  --epochs 500 --closstemp 0.1 --distance 0.1 --lam 1 --oe False  --tempt 1 --conu False --use-la False --comb False  --dismod avg --diskey 4 --weakth 0.55
