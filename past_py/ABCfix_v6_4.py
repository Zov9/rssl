...
#txtpath = "/data/lipeng/ABC/txt/try100_1214.txt"
txtpath = '/data/lipeng/ABC/txt/cf100_0225t'+args.tempt+'.txt'
...
def train(labeled_trainloader, unlabeled_trainloader, model, optimizer, ema_optimizer, criterion, epoch,ir2,scheduler, worst_k,learning_status,N):
    ...
    fdus = cal_fn_pair3(cls_rep_upsu_part,cls_center_upsu_part,num_classes,'cls_rep_upsu_part',txtpath)
