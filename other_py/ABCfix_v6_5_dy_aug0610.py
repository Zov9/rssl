...
if args.dataset=='cifar10':
    ...
    import dataset.fix_cifar10_1 as dataset1
    print(f'==> Preparing imbalanced CIFAR10')
    num_class = 10
elif args.dataset=='svhn':
    import dataset.fix_svhn as dataset
    import dataset.fix_svhn_1 as dataset1
    print(f'==> Preparing imbalanced SVHN')
    num_class = 10
elif args.dataset=='cifar100':
    #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!记得改回来(dataset应该是fix_cifar100而不是fix_cifar100_1)
    import dataset.fix_cifar100_1 as dataset
    import dataset.fix_cifar100_1 as dataset1
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch==101:
            #aug change here!!!!!!!!!!!!!!!!!!!!!
            if args.dataset == 'cifar10':
                train_labeled_set, train_unlabeled_set,_ = dataset1.get_cifar10('./data', N_SAMPLES_PER_CLASS,U_SAMPLES_PER_CLASS)
            elif args.dataset == 'svhn':
                train_labeled_set, train_unlabeled_set, _ = dataset1.get_SVHN('./data', N_SAMPLES_PER_CLASS,U_SAMPLES_PER_CLASS)
            elif args.dataset =='cifar100':
                train_labeled_set, train_unlabeled_set, _ = dataset1.get_cifar100('./data', N_SAMPLES_PER_CLASS,U_SAMPLES_PER_CLASS)
            
            unlabeled_trainloader = data.DataLoader(train_unlabeled_set, batch_size=args.batch_size, shuffle=True, num_workers=4,drop_last=True)
        
            #WARNING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            dataset1.update_dataset(train_labeled_set,twk)
        
            
        # Training part
        train_loss, train_loss_x, train_loss_u, abcloss,worst_k = train(labeled_trainloader,
                                                                                                unlabeled_trainloader,
                                                                                                model, optimizer,
                                                                                                ema_optimizer,
                                                                                                train_criterion,
                                                                                                epoch,ir2,scheduler,worst_k,
...
def train(labeled_trainloader, unlabeled_trainloader, model, optimizer, ema_optimizer, criterion, epoch,ir2,scheduler, worst_k,learning_status,N):
    ...
    worst_k = worstk(args.wk,distus,fdus)
    ...
    return (losses.avg, losses_x.avg, losses_u.avg, losses_abc.avg,worst_k)
